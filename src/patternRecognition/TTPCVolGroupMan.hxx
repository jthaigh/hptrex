...
namespace ND{
  ...
  class TTPCVolGroupMan{
    public:
      ...
      /// Get vector of groups at edge of volumes split into delta and non-delta
      std::vector< ND::THandle<ND::TTPCVolGroup> > GetAllEdgeGroups();
      ...
      std::vector< ND::THandle<ND::TTPCVolGroup> > GetFoci(std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > paths, float diffThreshold=.5);
      ...
      void CleanUpVertices(std::vector< ND::THandle<ND::TTPCVolGroup> > edgeGroups, std::vector< ND::THandle<ND::TTPCVolGroup> > vertices);
      ...
      /// Merge two groups and return the result including anything in between
      ND::THandle<ND::TTPCVolGroup> ExperimentalMergeGroups(ND::THandle<ND::TTPCVolGroup> group1, ND::THandle<ND::TTPCVolGroup> group2);
      /// Add anything inside this group to it
      void BulkGroup(ND::THandle<ND::TTPCVolGroup> group);
      /// Add anything inside each group to it
      void BulkGroups(std::vector< ND::THandle<ND::TTPCVolGroup> > groups);

      /// Break input tracks around any kinks found inside them
      std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > BreakPathsAboutKinks(std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > inPaths, bool tryChargeCut=false);
      ...
      void BuildGroupFriends(ND::THandle<ND::TTPCOrderedVolGroup> in, ND::TTPCConnection::Type type = ND::TTPCConnection::pathHits);
      /// Produce clusters in unordered group
      void ClusterGroupFriends(ND::THandle<ND::TTPCOrderedVolGroup> in, bool doClustering=false, bool checkX=false, bool partial=false);
      ...
      void BuildAllFriends(std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > paths);
      /// Separate hits assigned to incomplete paths so that each contains a unique set
      void SeparateHits(std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > paths);
      ...
      std::vector< ND::THandle<ND::TTPCVolGroup> > GetConnectedHits(ND::TTPCConnection::Type type=ND::TTPCConnection::path, ND::TTPCHitGroupings::Type typeFilter=ND::TTPCHitGroupings::all, bool usabilityCheck=false);
      /// Get hits in given group connected to this one within specified distance
      std::vector< ND::THandle<ND::TTPCVolGroup> > GetConnectedHits(ND::THandle<ND::TTPCVolGroup> in, ND::TTPCConnection::Type type=ND::TTPCConnection::path, ND::TTPCHitGroupings::Type typeFilter = ND::TTPCHitGroupings::all, bool usabilityCheck=false);
      ...
      ND::THandle<ND::TTPCVolGroup> GetUnusedHits(std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > paths);
      ...
      void AssociateUnusedWithJunctions(ND::THandle<ND::TTPCVolGroup> unused, std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > paths);
      ...
      std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > SanityFilter(std::vector< ND::THandle<ND::TTPCOrderedVolGroup> > input);
    ...
    private:
      ...
      ND::THandle<ND::TTPCVolGroup> fPrimaryHits;
